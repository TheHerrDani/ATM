...
import static com.daniel.sipos.zinkworks.controller.controlleradvice.GlobalExceptionHandler.GENERIC_ERROR;
import static com.daniel.sipos.zinkworks.service.services.AccountService.ACCOUNT_BALANCE_SHORTAGE;
import static com.daniel.sipos.zinkworks.service.services.AccountService.CAN_NOT_BE_0;
import static com.daniel.sipos.zinkworks.service.services.AccountService.MUST_BE_A_POSITIVE_NUMBER;
import static com.daniel.sipos.zinkworks.service.services.AccountService.MUST_BE_DIVISIBLE_BY_5;
import static com.daniel.sipos.zinkworks.service.services.AtmService.ATM_MONEY_SHORTAGE;
import static com.daniel.sipos.zinkworks.util.AccountConstants.BAD_ACCOUNT_NUMBER;
import static com.daniel.sipos.zinkworks.util.ControllerConstants.ATM_SHORTAGE_MODEL;
import static com.daniel.sipos.zinkworks.util.ControllerConstants.ATM_SHORTAGE_MODEL_2;
import static com.daniel.sipos.zinkworks.util.ControllerConstants.BAD_DISPENSE_MONEY_MODEL;
import static com.daniel.sipos.zinkworks.util.ControllerConstants.DISPENSE_MONEY_MODEL;
import static com.daniel.sipos.zinkworks.util.ControllerConstants.REQUESTED_AMOUNT_ERROR;
import static com.daniel.sipos.zinkworks.util.ControllerConstants.REQUESTED_AMOUNT_ERROR_2;
import static com.daniel.sipos.zinkworks.util.ControllerConstants.TOO_MUCH_DISPENSE_MONEY_MODEL;
