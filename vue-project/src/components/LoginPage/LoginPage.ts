...
export default class LoginPage extends Vue {
  ...
  async login() {
    ...
    this.validateAccountNr ? this.accountNrError = '' : this.accountNrError = 'The Account Number must be a nine decimal number';   
    this.validatePin ? this.pinError = '' : this.pinError = 'The PIN number must be a four decimal number';
  }
}
